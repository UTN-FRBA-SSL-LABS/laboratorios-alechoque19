...
> R:Inicializa el carrito en cero para evitar valores basura en la memoria y asegurar que comience vacío.
...
> R:Multiplicar el precio por la cantidad del producto
...
> R:Falla. El 5to carrito_agregar devuelve 1 en lugar de 0
...
> R:Sí, las líneas 29 y 30  tienen ##### porque no fueron ejecutadas por el set de tests analizado
...
> R:El unitario prueba partes aisladas y el de integración cómo interactúan. El unitario detectó primero el bug de carrito_total
...
> R:En C no hay control automático de límites de memoria (puede corromper datos), mientras que Python o Java controlan los rangos de forma segura
...
> R:Automatiza la validación, previene regresiones y es más confiable que solo revisar el código a simple vista
...
> R:Con cantidad 1 el cálculo matemático daba igual por coincidencia, pero con cantidades mayores se evidenció el fallo
